...
## Case 2: Test GPU acceleation version with MOOSE
## single crystal (BCC) case under tensile loadings
import jax
...
from applications.GPU.models_tantalum import CrystalPlasticity
